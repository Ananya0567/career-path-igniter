...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-md hover:bg-primary/90 hover:shadow-glow",
        destructive:
        ...
        gradient: "bg-gradient-primary text-primary-foreground shadow-lg hover:shadow-hover transform hover:-translate-y-0.5",
        glass: "bg-card/30 backdrop-blur-md border border-border/50 text-foreground hover:bg-card/50 hover:border-primary/50",
        hero: "bg-gradient-primary text-primary-foreground font-semibold shadow-lg hover:shadow-hover transform hover:-translate-y-1 hover:scale-105",
      },
      size: {
